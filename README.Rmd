...
[![R-universe version](https://m-muecke.r-universe.dev/treasury/badges/version)](https://m-muecke.r-universe.dev/treasury)
<!-- badges: end -->
...
subset(yield_curve, maturity == "10 year") |>
  ...
  labs(title = "US Treasury Yield Curve 2025 (10 Year Maturity)")
```
